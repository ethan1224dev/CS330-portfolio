...
public:
	...
	// method declaration to the public section of SceneManager class
	struct TEXTURE_INFO
	{
		std::string tag;
		uint32_t ID;
...
private:
	...
	//  RenderLaptop()
	//
	//  renders the finished laptop object with its base, screen, and hinges.
	///////////////////////////////////////////////////////////////////////////////
	void RenderLaptop();
	...
	//  RenderMug()
	//
	//  renders the hollow coffee mug with its rim and handle.
	///////////////////////////////////////////////////////////////////////////////
	void RenderMug();
	...
	//  RenderPencilHolder()
	//
	//  renders the hollow pencil holder and the two pencils.
	///////////////////////////////////////////////////////////////////////////////
	void RenderPencilHolder();
